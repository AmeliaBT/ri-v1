...
//value3="ftp://qa:FTPati123@208.184.212.185/RI-2020/ri5600.jpg"
...
<FormGroup className="input-row"><ControlLabel> 	 DMR #:	</ControlLabel><FormControl type="text" name="swo"   value={this.state.swo	} placeholder={this.state.swo	} onChange={this.handleChangeValue} />  </FormGroup> 
 ...
 <FormGroup className="input-row"><ControlLabel > Comment:</ControlLabel> 
  <textarea rows="3" type="textarea"  className="input-rowC" name="record"   value={this.state.record	} placeholder={this.state.record	} onChange={this.handleChangeValue}  /> 
   ...
   <Row> <Col sm={11} >
     <ControlLabel>Upload the photos <a href="http://10.4.5.6/QAG/GUI/"> here </a> and enter the links (http://10.4.5.6/QAGUploads/... ) below	</ControlLabel> 
     </Col>
     </Row>
  
     <Row> 
<Col sm={6} >
  <FormGroup className="input-row"> <ControlLabel>	</ControlLabel> 
  
  <FormControl type="text"  name="lwo"     placeholder="link to photo 1" onChange={this.handleChangeValueImg}  />   </FormGroup>  
...
<FormGroup className="input-row"><ControlLabel>	</ControlLabel> 
  ...
  <FormControl type="text" name="uwo"   placeholder="link to photo 2" onChange={this.handleChangeValueImg}   />  </FormGroup> 
...
<FormGroup className="input-row"><ControlLabel>Photo 1 (I:\QC-Reports\RI_Photos\) 	</ControlLabel><FormControl type="file"  name="lwo"     placeholder={this.state.lwo	} onChange={this.handleChangeValueImg}  />   </FormGroup>  
 ...
 <Col sm={5} >
<FormGroup className="input-row"><ControlLabel> 	Photo 2	</ControlLabel>         
  <FormControl type="file" name="uwo"   placeholder={this.state.uwo	} onChange={this.handleChangeValueImg} ref={this.fileInput}    />  </FormGroup> 
